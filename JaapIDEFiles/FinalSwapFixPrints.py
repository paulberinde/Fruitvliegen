...
def runProgram(goal, genome):
    ...
    print "First pattern: ", first_node.pattern
    print "First misplacedSum: ", first_node.misplacesSum
    print "First score: ", first_node.score
    ...
    while solved == False:
        ...
        if (len(priority_queue.queue) > 500000):
            ...
            print "Step highest:", highest
            print "Self:", (priority_queue.queue[0][1]).state
            print "Self step:", (priority_queue.queue[0][1]).steps
            print "Self score:", (priority_queue.queue[0][1]).score
            print "Self pattern:", (priority_queue.queue[0][1]).pattern
            print "Self misplaced sum:", (priority_queue.queue[0][1]).misplacesSum
            print "Worst pattern:", (priority_queue.queue[400000][1]).pattern
            print "Worst misplaced sum:", (priority_queue.queue[400000][1]).misplacesSum
            print "Worst score:", (priority_queue.queue[400000][1]).score
            priority_queue.queue = priority_queue.queue[0:400000]
        # print length
