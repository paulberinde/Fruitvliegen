"""""""""""""""""""""""""""""""""""""""""
 Two-Ended Basic Sorting - 100 sample run
"""""""""""""""""""""""""""""""""""""""""
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
 Team Melanogaster
...
class TwoEndedSwap(object):
    ...
    At all times the sorting class has a particular initial subset and solution
    subset.
    It also has a counter, switcher boolean, pattern length and searched index
    variables.
    
    Subclasses of TwoEndedSwap are a variant of pancake / selection sort.
    It selects the lowest number, and moves it to the front of the list.
    """
